defmodule Compounds.Icon do
  ...
  ## Image
  Don't provide a block to this component if you are using the src attribute.
  ```html
  ...
  ## SVG
  Simply provide an SVG element as a child to this component.
  DON'T provide a `src` attribute if you are using an SVG element.
  ```html
    <Compounds.Icon.icon>
  ...
  def icon(assigns) do
    assigns = assign(assigns, :src_exists, assigns[:src] != nil)
